...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @param {string|Object} style 图标类型,默认为空，可选项：ok | cancel | warning | null
	...
	function toast() {
	    ...
	    switch (options.style) {
	        case 'ok':
	            options.style = 'weui-icon-success-no-circle';
	            break;
	        case 'cancel':
	            options.style = 'weui-icon-cancel text-white';
	            break;
	        case 'warning':
	            options.style = 'weui-icon-warn';
	            break;
	        default:
	            options.style = 'hide';
	            break;
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"<%= className %>\"> <div class=weui-mask_transparent></div> <div class=weui-toast style=min-height:initial> <i class=\"weui-icon_toast <%= style %>\" style=font-size:55px></i> <div class=weui-toast__content style=margin:0;line-height:35px><%=content%></div> </div> </div> ";
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * });
	 */
	function topTips(content, style) {
	    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	    ...
	    switch (options.style) {
	        case 'success':
	            options.style = 'bg-success';
	            break;
	        case 'warning':
	            options.style = 'bg-warning';
	            break;
	        default:
	            options.style = 'bg-danger';
	            break;
	    }
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"weui-toptips <%= style %> <%= className %>\" style=display:block><%= content %></div> ";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	 ...
	 * @param {object=} options 配置项
	 * @param {string=} options.className 自定义类名
	 * @param {bool=} options.delete 是否显示删除
	...
	function gallery(url) {
	    ...
	    if (!options.delete) {
	        $gallery.find('.weui-gallery__opr').hide();
	        $gallery.find('.weui-gallery__img').css({ 'bottom': 0 });
	    } else {
